...
public class Poker {
    ...
    public void endGame() {
        String endMessage = (player.getChips() == 0) ? "\nYou have unfortunately lost all your chips. Looks like you can't play anymore." : "\nThe deck is empty! The game has ended.";
        System.out.println(endMessage);
        System.out.println("\nYou ended up with " + player.getChips() + " chips.");

        player.clearHand();
        String playAgain = "";
        do {
            System.out.println("\nPWould you like to play Again? (Yes or No)");
